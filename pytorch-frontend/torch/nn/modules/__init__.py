...
from .practica2Linear import Practica2Linear
...
__all__ = [
    'Module', 'Identity', 'Linear', 'SimulatedLinear','Practica2Linear', 'Conv1d', 'Conv2d', 'Conv3d', 'ConvTranspose1d', 'SimulatedConv1d', 'SimulatedConv2d', 'SimulatedConv3d', 
