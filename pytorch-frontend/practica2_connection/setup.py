...
practica2_src_dir='../../practica2/src'


list_of_src_files_to_link=['torch_practica2.cpp']
...
setup(name='torch_practica2',
      ext_modules=[cpp_extension.CppExtension('torch_practica2', list_of_src_files_to_link, include_dirs=['../../practica2/include'])],
